...
<body class="bg-dark-950 text-gray-100 min-h-screen">
        ...
        <div class="flex justify-between items-start mb-12">
            <div>
                <div class="flex items-center gap-3">
                    <a href="<?php echo e(route('server.list')); ?>" class="p-2 hover:bg-white/5 rounded-xl text-dark-500 transition-all" title="Volver al Listado">
                ...
                <p class="text-sm text-dark-500 mt-2"><?php echo e($current_time); ?></p>
            </div>
            ...
            <div class="bg-dark-900 border border-dark-800 rounded-xl p-6 shadow-lg">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold text-white" x-text="phpVersion"><?php echo e($php_version); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-dark-900 border border-dark-800 rounded-xl p-6 shadow-lg">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold text-white" x-text="'v' + laravelVersion">v<?php echo e($laravel_version); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-dark-900 border border-dark-800 rounded-xl p-6 shadow-lg">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-lg font-bold text-white" x-text="osName"><?php echo e($os_name); ?></p>
                        <p class="text-dark-400 text-sm">Tiempo de Actividad</p>
                        <p class="text-sm font-bold text-white truncate" x-text="uptime"><?php echo e($uptime); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-dark-900 border border-dark-800 rounded-xl p-6 shadow-lg">
                <div class="flex items-center gap-4 mb-4">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold text-white" x-text="memoryUsage"><?php echo e($memory_usage); ?></p>
                    </div>
                </div>
                ...
                <div class="flex justify-between mt-2">
                    ...
                    <p class="text-[10px] text-dark-500">Límite: <span x-text="memoryLimit"><?php echo e($memory_limit); ?></span></p>
                </div>
            </div>
            ...
            <div class="bg-dark-900 border border-dark-800 rounded-xl p-6 shadow-lg md:col-span-1 lg:col-span-1">
                <div class="flex items-center gap-4 mb-4">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold text-white" x-text="diskFree + ' Libres'"><?php echo e($disk_free); ?> Libres</p>
                    </div>
                </div>
                <div class="w-full bg-dark-800 rounded-full h-2">
                    <div class="h-2 rounded-full transition-all duration-500" 
                ...
                <div class="flex justify-between mt-2">
                    <p class="text-[10px] text-dark-500">Total: <span class="text-emerald-400" x-text="diskTotal"><?php echo e($disk_total); ?></span></p>
                    <p class="text-[10px] text-dark-500">Uso: <span class="text-emerald-400" x-text="diskUsedPercent + '%'"><?php echo e($disk_used_percent); ?>%</span></p>
                </div>
            </div>
    ...
    function serverMonitor() {
        return {
            processes: <?php echo json_encode($processes, 15, 512) ?>,
            loadAvg: <?php echo json_encode($load_avg, 15, 512) ?>,
            uptime: '<?php echo e($uptime); ?>',
            dockerContainers: <?php echo json_encode($docker_containers, 15, 512) ?>,
            networkStats: <?php echo json_encode($network_stats, 15, 512) ?>,
            servicesStatus: <?php echo json_encode($services_status, 15, 512) ?>,
            recentLogs: <?php echo json_encode($recent_logs, 15, 512) ?>,
            dbStats: <?php echo json_encode($db_stats, 15, 512) ?>,
            loggedUsers: <?php echo json_encode($logged_users, 15, 512) ?>,
            swapUsage: <?php echo json_encode($swap_usage, 15, 512) ?>,
            ioWait: '<?php echo e($io_wait); ?>',
            listeningPorts: <?php echo json_encode($listening_ports, 15, 512) ?>,
            dmesgLogs: <?php echo json_encode($dmesg_logs, 15, 512) ?>,
            phpVersion: '<?php echo e($php_version); ?>',
            laravelVersion: '<?php echo e($laravel_version); ?>',
            memoryUsage: '<?php echo e($memory_usage); ?>',
            memoryLimit: '<?php echo e($memory_limit); ?>',
            diskTotal: '<?php echo e($disk_total); ?>',
            diskFree: '<?php echo e($disk_free); ?>',
            diskUsedPercent: <?php echo e($disk_used_percent); ?>,
            osName: '<?php echo e($os_name); ?>',
            servers: <?php echo json_encode($servers, 15, 512) ?>,
            selectedServerId: '<?php echo e($selected_server_id_encrypted); ?>',
            selectedServerName: '<?php echo e($selected_server_name); ?>',
            ...
            async refreshProcesses() {
                try {
                    const response = await fetch(`<?php echo e(route('server.processes')); ?>?server_id=${this.selectedServerId}`);
            ...
            async addServer() {
                ...
                const url = this.isEditing ? `/server/${this.newServer.id}` : '<?php echo e(route('server.add')); ?>';
...
</html><?php /**PATH /var/www/resources/views/server/info.blade.php ENDPATH**/ ?>