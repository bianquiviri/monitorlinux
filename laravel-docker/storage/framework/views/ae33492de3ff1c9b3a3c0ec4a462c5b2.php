            ...
            <div class="bg-dark-900 border border-dark-800 rounded-xl p-6 shadow-lg">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold text-white"><?php echo e($php_version); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-dark-900 border border-dark-800 rounded-xl p-6 shadow-lg">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold text-white">v<?php echo e($laravel_version); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-dark-900 border border-dark-800 rounded-xl p-6 shadow-lg">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold text-white"><?php echo e($os_name); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-dark-900 border border-dark-800 rounded-xl p-6 shadow-lg">
                <div class="flex items-center gap-4 mb-4">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold text-white"><?php echo e($memory_usage); ?></p>
                    </div>
                </div>
                <div class="w-full bg-dark-800 rounded-full h-2">
                    <div class="bg-purple-500 h-2 rounded-full" style="width: <?php echo e(round(memory_get_usage(true) / (128 * 1024 * 1024) * 100)); ?>%"></div>
                </div>
                <p class="text-xs text-dark-500 mt-2">Límite: <?php echo e($memory_limit); ?></p>
            </div>
            ...
            <div class="bg-dark-900 border border-dark-800 rounded-xl p-6 shadow-lg md:col-span-2">
                <div class="flex items-center gap-4 mb-4">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold text-white"><?php echo e($disk_used_percent); ?>% usado</p>
                    </div>
                </div>
                <div class="w-full bg-dark-800 rounded-full h-3">
                    <div class="bg-gradient-to-r from-green-400 via-yellow-400 to-red-500 h-3 rounded-full" style="width: <?php echo e($disk_used_percent); ?>%"></div>
                </div>
                <div class="flex justify-between mt-2 text-sm">
                    <span class="text-dark-400">Usado: <?php echo e($disk_total); ?></span>
                    <span class="text-dark-400">Libre: <?php echo e($disk_free); ?></span>
                </div>
            </div>
